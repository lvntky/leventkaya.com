...
date: 2024-11-30
description: "Building fbgl — a minimal Linux framebuffer graphics library in C with zero dependencies. Covers mmap-based framebuffer access via /dev/fb0, the drawing API, and TGA texture loading."
