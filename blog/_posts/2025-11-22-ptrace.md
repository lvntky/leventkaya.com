...
date: 2025-11-22
description: "Why ptrace's one-tracer rule breaks debugger-on-debugger scenarios, and a deep dive into its API design flaws: silent state inheritance, overloaded void* parameters, and ambiguous error returns."
